...
Minimal Flask shell following the FP-002 mounting contract (task card FP-009
§3: FP-002 未合入 → 自建最小 Flask 壳挂载本蓝图). FP-002's merge extends
...
def register_blueprints(app: Flask) -> None:
    ...
    from social_app import friends
