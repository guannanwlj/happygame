...
Minimal Flask shell following the FP-002 mounting contract (task card FP-007
...
def register_blueprints(app: Flask) -> None:
    ...
    from social_app import pending_requests

    app.register_blueprint(pending_requests.bp)
