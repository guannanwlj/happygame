...
Minimal Flask shell following the FP-002 mounting contract (task card FP-008
...
def register_blueprints(app: Flask) -> None:
    ...
    from social_app import friend_request_actions

    app.register_blueprint(friend_request_actions.bp)
