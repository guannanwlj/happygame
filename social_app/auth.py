...
Task card FP-008 §3.2 / §6: until FP-003 lands, this module provides the
minimal contract the friend-request actions call into. Login state lives in
the session under ``user_id`` (tests inject it via ``session_transaction``);
